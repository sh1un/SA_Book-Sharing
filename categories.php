			...
			<div class="inner">
				...
				<section>
					...
					<select name="way" onchange="location=this.value;" required>
						...
						<option value="categories.php?cat=&value=<?php echo $category?>way=最新">最新
						<option value="categories.php?cat=&value=<?php echo $category?>way=最舊">最舊
						<option value="categories.php?cat=&value=<?php echo $category?>way=最多愛心">最多愛心
						<option value="categories.php?cat=&value=<?php echo $category?>way=名稱">名稱
					</select>
