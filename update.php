...
function renew(index){
	...
	document.a.udaddress.length=department[index].length;	// 刪除多餘的選項
}
</script>
</head>
                ...
                <section id="banner">
                    ...
                    <?php while($row = mysqli_fetch_assoc($rs)){ ?>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="input_box" value="<?php echo $row['name']; ?>" name="udname" required></td>
                        </tr>
                        <tr>
                            <td>帳號</td>
                            <td><input type="text" class="input_box" value="<?php echo $row['account']; ?>" name="udaccount" required></td>
                        </tr>
                        <tr>
                            <td>密碼</td>
                            <td><input type="text" class="input_box" value="<?php echo $row['password']; ?>" name="udpassword" required></td>
                        </tr>
                        <tr>
                            <td>電子信箱</td>
                            <td><input type="text" class="input_box" value="<?php echo $row['email']; ?>" name="udemail" required></td>
                        </tr>
                        <tr>
                            <td>生日</td>
                            <td><input type="date" class="input_box" value="<?php echo $row['birth']; ?>" name="udbirth" required></td>
                        </tr>
                        <tr>
                            <td>居住區域</td>
                            <td><select name="udarea" onChange="renew(this.selectedIndex);" value="<?php echo $row['area']; ?>" required>
                            ...
                            <select name="udaddress" value="<?php echo $row['address']; ?>" required>
