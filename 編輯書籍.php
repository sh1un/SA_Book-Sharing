                    ...
                    <div class="posts">
                        ...
                        ?>
                            <article>
                                ...
                                <input type="hidden" value=<?php echo $_POST['book_image']; ?> name="book-image">
                                    <img class="img_item" src='images/<?php echo $_POST['book_image']; ?>' alt="" /></div>
                                書名：<h3><input type="text" name="udbook-name" id="book-name" value="<?php echo $_POST['book_name'] ?>"/></h3>
                                編號 : <input type="hidden" value=<?php echo $_POST['book_id'] ?> name="book_id">
                                <?php echo $_POST['book_id'] ?>
                                ...
                                <?php echo $_POST['up_date'] ?>
                                <br>作者：<input type="text" name="udbook-author" id="book-author"  value="<?php echo $_POST['book_author'] ?>" required>
                                <br>出版社：<input type="text" name="udpublic" id="public" value="<?php echo $_POST['public'] ?>"/>
                                <br>出版日期：<input type="date" name="udpublic-date" id="public-date" value="<?php echo $_POST['public_date'] ?>"/>
