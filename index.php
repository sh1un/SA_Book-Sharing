                                    ...
                                    <ul class="actions">
                                        <?php if (isset($account)) {
                                            if ($rslt['book_owner'] == $account) { ?>
                                                <li><a href="書籍內容.php?book_name=<?php echo $rslt['book_name'] ?>&ISBN=<?php echo $rslt['ISBN'] ?>" class="button">下架書籍</a>
                                                </li><?php } else { ?>
                                                <li><a href="書籍內容.php?book_name=<?php echo $rslt['book_name'] ?>&ISBN=<?php echo $rslt['ISBN'] ?>" class="button">立即借閱</a>
                                                </li><?php }
                                                } else { ?>
                                            <li><a href="書籍內容.php?book_name=<?php echo $rslt['book_name'] ?>&ISBN=<?php echo $rslt['ISBN'] ?>" class="button">立即借閱</a>
                                            </li><?php } ?>
